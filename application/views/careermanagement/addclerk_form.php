                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Add Clerk</h3></div>
                                    <div class="card-body">
                                        <form action='<?php echo base_url("careermanagement/addclerk_submit")?>'  method="POST">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputLastName" type="text" placeholder="Enter last name" name="surname"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
